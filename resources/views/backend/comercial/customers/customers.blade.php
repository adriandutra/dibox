		...
		<div class="dropdown" style="">
			...
			<ul class="dropdown-menu drop-actions">
				...
				<div class="panel-body">
						...
						data-toggle="table" 
						data-url="{{url('api/v1/comercial/customers') }}"  
               			...
               			data-resizable="true"
						    ...
						    <!-- END list_show -->
						        ...
						        <th data-field="name"  data-sortable="true" data-align="center">Nombre</th>
						     	...
						     	<th data-field="creation_date" data-sortable="true" data-formatter="datelabel" data-align="center">Creado</th>
						   
						 	     <th data-field="last_payment" data-sortable="true" data-formatter="datelabel" data-align="center">U.pago</th>
...
function actionicons(value, row) {
		...
		html+='<a href="/customercredit/'+row.id+'" title="Editar Tarjeta"><i class="glyphicon glyphicon-credit-card icon-credit-card" style="{edit_perm}"></i></a> ';
		
		html+='<a href="/devices/'+row.id+'" title="Editar Dispositivos"><i class="glyphicon glyphicon-phone icon-phone" style="{edit_perm}"></i></a> ';
		...
		html+='<a href="paymentdetail/'+row.id+'" title="Detalle de transacciones"><i class="glyphicon glyphicon-usd icon-usd"></i></a> ';
