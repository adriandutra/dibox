		...
		<div class="dropdown" style="">
			...
			<ul class="dropdown-menu drop-actions">
				...
				<div class="panel-body">
						...
						data-cookie="true"
               			data-cookie-id-table="resellers"
               			data-resizable="true"
						 ><thead>
						    <tr> 
						    <!-- BEGIN list_show -->
						    ...
						    <!-- END list_show -->
						        ...
						        <th data-field="services"  data-sortable="true" data-align="center">Servicios</th>
						        
						        <th data-field="name_package"  data-sortable="true" data-align="center">Paquetes</th>
...
function actionicons(value, row) {
		...
		html+='<a href="resellersp/'+row.id+'" title="Editar Precios"><i class="glyphicon glyphicon-shopping-cart icon-shopping-cart" style="{edit_perm}"></i></a> ';
