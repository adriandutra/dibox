		...
		<div class="dropdown" style="">
			...
			<ul class="dropdown-menu drop-actions">
				...
				<div class="panel-body">
						...
						data-toggle="table" 
						data-url="{{url('api/v1/content/listvodhls') }}" 
						...
						data-cookie="true"
               			data-cookie-id-table="listvodhls"
               			data-resizable="true"
						 ><thead>
						    <tr> 
						    <!-- BEGIN list_show -->
						    ...
						    <!-- END list_show -->
						        ...
						        <th data-field="uid"  data-sortable="true" data-align="center">UID</th>
						     	...
						     	<th data-field="hls" data-sortable="true" data-align="center">Hls</th>
...
@section('custom-scripts')
	...
	var url ="/vodhls";
	unction actionicons(value, row) {
		
		html=' <a href="#" class="preview" data-action="vodhls"><i class="glyphicon glyphicon-film icon-film" title="Player"></i></a> ';
