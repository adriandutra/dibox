		...
		<div class="dropdown" style="">
			...
			<ul class="dropdown-menu drop-actions">
				...
				<div class="panel-body">
						...
						data-toggle="table" 
						data-url="{{url('api/v1/content/advertisinglist') }}"  
						...
						data-cookie="true"
               			data-cookie-id-table="advertisinglist"
               			data-resizable="true"
						 ><thead>
						    <tr> 
						    <!-- BEGIN list_show -->
						    ...
						    <!-- END list_show -->
						        ...
						        <th data-field="name_reseller"  data-sortable="true" data-align="center">Reseller</th>
						        						     
						     	<th data-field="description" data-sortable="true" data-align="center">Descripci&oacute;n</th>
						     	
						     	<th data-field="url" data-sortable="true" data-align="center">Url</th>
